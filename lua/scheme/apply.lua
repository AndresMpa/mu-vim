...
local function paint_diff(p)
	...
	vim.api.nvim_set_hl(0, "DiffviewFilePanelConflicts", { fg = purple })
	...
	-- add=green · delete=red · merge=purple · untracked=yellow (theme palette)
	vim.api.nvim_set_hl(0, "DiffviewStatusAdded", { fg = green })
	vim.api.nvim_set_hl(0, "DiffviewStatusUntracked", { fg = yellow })
	vim.api.nvim_set_hl(0, "DiffviewStatusModified", { fg = yellow })
	vim.api.nvim_set_hl(0, "DiffviewStatusRenamed", { fg = yellow })
	vim.api.nvim_set_hl(0, "DiffviewStatusCopied", { fg = green })
	vim.api.nvim_set_hl(0, "DiffviewStatusTypeChange", { fg = yellow })
	vim.api.nvim_set_hl(0, "DiffviewStatusUnmerged", { fg = purple })
	vim.api.nvim_set_hl(0, "DiffviewStatusUnknown", { fg = purple })
...
-- Git status colors shared across Diffview / tree / signs / statusline.
local function paint_git(p)
	if not p or not p.bg then
		return
	end
	local green, red, yellow, purple, dim = p.green, p.red, p.yellow, p.purple, p.dim
	...
	-- nvim-tree: add green · delete red · merge purple · untracked yellow
	hi("NvimTreeGitNew", green)
	hi("NvimTreeGitStaged", green)
	hi("NvimTreeGitDeleted", red)
	hi("NvimTreeGitDirty", yellow)
	hi("NvimTreeGitRenamed", yellow)
	hi("NvimTreeGitMerge", purple)
	hi("NvimTreeGitIgnored", dim)
	hi("NvimTreeGitNewIcon", green)
	hi("NvimTreeGitStagedIcon", green)
	hi("NvimTreeGitDeletedIcon", red)
	hi("NvimTreeGitDirtyIcon", yellow)
	hi("NvimTreeGitRenamedIcon", yellow)
	hi("NvimTreeGitMergeIcon", purple)
	hi("NvimTreeGitIgnoredIcon", dim)
	hi("NvimTreeFileNew", green)
	hi("NvimTreeFileStaged", green)
	hi("NvimTreeFileDeleted", red)
	hi("NvimTreeFileDirty", yellow)
	hi("NvimTreeFileRenamed", yellow)
	hi("NvimTreeFileMerge", purple)
	hi("NvimTreeFileIgnored", dim)
end

function M.paint_diff(p)
	p = p or vim.g.muvim_palette
	paint_diff(p)
	paint_git(p)
end
